...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (md5($_POST['password']) == $user['password']) {
        if ($_POST['newpassword'] == $_POST['renewpassword']) {
            ...
            $query = "UPDATE nguoidung SET updated_at='" . $updated_at . "',password='" . $password . "'WHERE  email='" . $email . "'";
            execute($query);
                    ...
                    <ul>
                        <li>
                            ...
                            <ul style="margin-left: 20px;">
                                <li><a href="./canhan.php">Hồ sơ</a></li>
                                <li><a style="border-bottom: 3px orange solid;" href="./doimatkhau.php">Đổi mật khẩu</a></li>
