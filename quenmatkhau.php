...
<body>
    ...
    <div class="content_quemmatkhau">
        <div id="khung_1" class="khungquenmatkhau">

            <a href="./doimatkhau.php" id="muiten">&#8592</a>
            <h4 style="text-align: center;color:black;">Đặt Lại Mật Khẩu</h4>

            <p style="text-align: center;color:black;">Vui lòng chọn phương thức bạn muốn đặt lại mật khẩu:</p>
            <ul>
                <li onclick="maillaymk()"><i class="fa fa-envelope-o" aria-hidden="true"></i> Email: <?= $email ?></li>
                <li><i class="fa fa-phone" aria-hidden="true"></i> Số Điện thoại: <?= $sdt ?> </li>
            </ul>
        </div>
        <div id="khung_2" class="khungquenmatkhau">
        ...
        <div id="khung_3" class="khungquenmatkhau">

            <a href="./login.php" id="muiten">&#8592</a>
            <h4 style="text-align: center;color:black;">Đặt Lại Mật Khẩu</h4>
            <form action="./thongbaomatkhau.php" method="POST">
                <div class="form-group">
                    <label for="exampleFormControlInput1">Email tài khoản muốn đặt lại mật khẩu:</label>
                    <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com" name="email" required>
                    <button class="btn btn-primary" style="margin-top: 20px;">Xác nhận</button>
                </div>
