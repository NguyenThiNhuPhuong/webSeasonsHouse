...
if (!empty($_POST)) {
    ...
    $id="ĐH".date('hsi') . str_pad(mt_rand(1, 9999),4, '0', STR_PAD_LEFT);
    $query = "INSERT INTO orders (id,order_email,fullname,address,phone_number,email,total,order_date) VALUES('".$id."','" . $useremail ."','" . $_POST['fullname'] .  "','" . $_POST['address'] . "','" . $_POST['phone_number'] . "','" . $_POST['email'] ."','" . $_POST['total']. "','" . $order_date . "')";
    execute($query);
    $query = "SELECT * FROM orders where order_date ='".$order_date."'";
    $order = executeResult($query, true);
    $order_id = $order['id'];
    $idList = [];
    ...
    foreach ($cartList as $item) {
        ...
        $query = "INSERT INTO order_details (order_id,product_id,product_title,num,price) VALUES('" . $order_id .  "','" . $item['id']  . "','" . $item['title']  . "','" . $num  . "','" . $item['price'] . "')";
        execute($query);
    }
...
<body>
    ...
    <div class="super_container">
        ...
        <div class="content">
            <h3 class="text-center" style="margin-top: 30px;margin-bottom: 30px">Đặt hàng</h3>
            <div class="thanhtoan_row">
                <div class="thanhtoan_benphai">
                    <table class="table table-bordered table-hover">
                        <thead class="thead-dark">
                            <tr>
                                <th scope="col">STT</th>
                                <th scope="col">Tên sản phẩm</th>
                                <th class="anh_thanhtoan" scope="col">Hình ảnh</th>
                        ...
                        <tbody>
                            ...
                            for ($i = 0; $i < count($cartList); $i++) {
                                ...
                                <td class='anh_thanhtoan'><img  src='" . $cartList[$i]['thumbnail'] . "' alt='ảnh' style='width:100px'></td>
                                <td>" . $num . "</td>
                ...
                <div class="thanhtoan_bentrai">
                    <form action="" method="POST">
                        <div class="form-group">
                            <label for="exampleFormControlInput1">Họ và tên</label>
                            <input type="text" name="fullname" class="form-control" id="exampleFormControlInput1" placeholder="Nguyễn Văn A" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" name="phone_number" class="form-control" id="exampleFormControlInput3" placeholder="0707583179" required>
                        </div>
                        <div class="form-group">
                            <label for="exampleFormControlInput4">Địa chỉ giao hàng</label>
                            <input type="text" name="address" class="form-control" id="exampleFormControlInput4" placeholder="Thuận Hiệp, Bình Thuận, Tây Sơn, Bình Định" required>
                        </div>
                        <div class="form-group">
